...
from .models import Book, Category, BookInstance
from django.contrib.auth.forms import UserCreationForm
from  .forms import CreateUserForm, RenewBookForm
...
def search_book(request):
    searched_books = Book.objects.filter(title__icontains = request.POST.get('name_of_book', default="")) 
